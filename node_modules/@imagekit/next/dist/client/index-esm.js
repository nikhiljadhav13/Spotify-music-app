...
const ImageKitContext = createContext({});
/**
...
const ImageKitProvider = props => {
  ...
  return React.createElement(ImageKitContext.Provider, {
    value: {
      urlEndpoint,
      transformationPosition
    }
...
const Image = props => {
  ...
  const _a = Object.assign(Object.assign({}, contextValues), props // Override with props
    ...
    nonIKParams = __rest(_a, ["transformation", "unoptimized", "quality", "src", "queryParameters", "urlEndpoint", "transformationPosition", "responsive", "loader"]);
  ...
  if (unoptimized) {
    return React.createElement(NextImage, Object.assign({
      unoptimized: true
    }, nonIKParams, {
      src: buildSrc({
        urlEndpoint,
  ...
  if (!responsive) {
    return React.createElement(NextImage, Object.assign({
      ...
      src: buildSrc({
        ...
        transformation: [...finalTransformation, Object.assign({}, propsTransformation)]
      })
    }));
  }
  ...
  return (
    // Always keep src in the end
    React.createElement(NextImage, Object.assign({
      loader: ({
        src,
        width
      }) => {
        ...
        const finalSrc = buildSrc({
          ...
          transformationPosition,
          transformation: [...finalTransformation, Object.assign(Object.assign({}, propsTransformation), {
            width,
            crop: "at_max"
          })]
        });
...
const Video = forwardRef((props, ref) => {
  ...
  const _a = Object.assign(Object.assign({}, contextValues), props // Override with props
    ...
    nonIKParams = __rest(_a, ["transformation", "src", "queryParameters", "urlEndpoint", "transformationPosition"]);
  if (!urlEndpoint || urlEndpoint.trim() === "") {
    if (process.env.NODE_ENV !== "production") {
      console.error("urlEndpoint is neither provided in this component nor in the ImageKitContext.");
    }
